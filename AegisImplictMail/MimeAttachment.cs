...
namespace AegisImplicitMail
{
    ...
    public class MimeAttachment : Attachment
    {
        ...
        public MimeAttachment(Stream contentStream) : this(contentStream, new ContentType(MediaTypeNames.Application.Octet))
        {
        ...
        public MimeAttachment(Stream contentStream, ContentType contentType) : base(contentStream, contentType) { }

        public MimeAttachment(Stream contentStream, string name, string mediaType) : base(contentStream, name, mediaType) { }
