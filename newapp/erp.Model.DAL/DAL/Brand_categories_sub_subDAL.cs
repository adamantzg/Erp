...
namespace erp.Model.DAL
{
    public class Brand_categories_sub_subDAL
	{
		...
		public static Brand_categories_sub_sub GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM brand_categories_sub_sub WHERE brand_sub_sub_id = @id", conn);
		...
		public static void Delete(int brand_sub_sub_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = Utils.GetCommand("DELETE FROM brand_categories_sub_sub WHERE brand_sub_sub_id = @id" , conn);
