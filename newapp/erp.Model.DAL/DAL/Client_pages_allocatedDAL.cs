...
namespace erp.Model.DAL
{
    public class Client_pages_allocatedDAL
	{
		...
		public static List<Client_pages_allocated> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM client_pages_allocated", conn);
        ...
        public static List<Client_pages_allocated> GetByPageAndUser(int user_id, string page_Url = "")
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand(@"SELECT client_pages_allocated.userpage_id AS userpage_id,
		...
		public static Client_pages_allocated GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM client_pages_allocated WHERE userpage_id = @id", conn);
		...
		public static void Delete(int userpage_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = Utils.GetCommand("DELETE FROM client_pages_allocated WHERE userpage_id = @id" , conn);
