...
namespace erp.Model.DAL
{
    public class Category1DAL
	{
		...
		public static List<Category1> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM category1", conn);
		...
		public static Category1 GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM category1 WHERE category1_id = @id", conn);
		...
		public static void Delete(int category1_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM category1 WHERE category1_id = @id" , conn);
