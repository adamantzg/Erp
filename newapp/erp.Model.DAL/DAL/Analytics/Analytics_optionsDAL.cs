...
namespace erp.Model.DAL
{
    public class Analytics_optionsDAL
	{
		...
		public static List<Analytics_options> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM analytics_options", conn);
		...
		public static Analytics_options GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM analytics_options WHERE option_id = @id", conn);
		...
		public static Analytics_options GetFromDataReader(MySqlDataReader dr)
		{
            ...
            o.color_code = string.Empty + Utilities.GetReaderField(dr, "color_code");
			return o;
		...
		public static void Delete(int option_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM analytics_options WHERE option_id = @id" , conn);
