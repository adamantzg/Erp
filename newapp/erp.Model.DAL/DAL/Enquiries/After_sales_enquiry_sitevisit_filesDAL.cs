...
namespace erp.Model.DAL
{
    public class After_sales_enquiry_sitevisit_filesDAL
	{
		...
		public static List<After_sales_enquiry_sitevisit_files> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM after_sales_enquiry_sitevisit_files", conn);
		...
		public static After_sales_enquiry_sitevisit_files GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM after_sales_enquiry_sitevisit_files WHERE file_id = @id", conn);
		...
		public static void Delete(int file_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = Utils.GetCommand("DELETE FROM after_sales_enquiry_sitevisit_files WHERE file_id = @id" , conn);
        ...
        public static List<After_sales_enquiry_sitevisit_files> GetForVisit(int sitevisit_id)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM after_sales_enquiry_sitevisit_files WHERE sitevisit_id = @sitevisit_id", conn);
