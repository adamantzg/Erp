...
namespace erp.Model.DAL
{
	public class Contract_sales_forecastDAL
	{
		...
		public static List<Contract_sales_forecast> GetForCompany(int company_id)
		{
			...
			{
				conn.Open();
				MySqlCommand cmd = Utils.GetCommand(GetSelectSql() + " WHERE client_id = @client_id", conn);
		...
		public static Contract_sales_forecast GetById(int id)
		{
			...
			{
				conn.Open();
				MySqlCommand cmd = Utils.GetCommand("SELECT * FROM contract_sales_forecast WHERE forecast_id = @id", conn);
		...
		public static void Delete(int forecast_id)
		{
			...
			try
			{
				...
				var cmd = Utils.GetCommand("DELETE FROM contract_sales_forecast WHERE forecast_id = @id", conn);
