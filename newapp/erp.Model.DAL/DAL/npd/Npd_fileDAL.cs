...
namespace erp.Model.DAL
{
    public class Npd_fileDAL
	{
		...
		public static List<Npd_file> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM npd_file", conn);
        ...
        public static List<Npd_file> GetByNpd(int npd_id)
        {
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM npd_file WHERE npd_id = @npd_id", conn);
		...
		public static Npd_file GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM npd_file WHERE file_id = @id", conn);
		...
		public static void Delete(int file_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM npd_file WHERE file_id = @id" , conn);
