...
namespace erp.Model.DAL
{
    public class Npd_filetypeDAL
	{
		...
		public static List<Npd_filetype> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM npd_filetype", conn);
		...
		public static Npd_filetype GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM npd_filetype WHERE type_id = @id", conn);
		...
		public static void Delete(int type_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM npd_filetype WHERE type_id = @id" , conn);
