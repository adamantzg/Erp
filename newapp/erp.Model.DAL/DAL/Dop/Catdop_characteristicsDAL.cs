...
namespace erp.Model.DAL
{
    public class Catdop_characteristicsDAL
	{
		...
		public static List<Catdop_characteristics> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM catdop_characteristics", conn);
        ...
        public static List<Catdop_characteristics> GetForCategory(int categorydop_id)
        {
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM catdop_characteristics WHERE categorydop_id = @category_id", conn);
		...
		public static Catdop_characteristics GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM catdop_characteristics WHERE characteristic_id = @id", conn);
		...
		public static void Delete(int characteristic_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM catdop_characteristics WHERE characteristic_id = @id" , conn);
