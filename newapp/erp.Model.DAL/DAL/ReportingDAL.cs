...
using System.Linq;
using System.Text;
using erp.Model.Reporting;
using MySql.Data;
using MySql.Data.MySqlClient;

namespace erp.Model.DAL.Reporting
{
    public class ReportingDAL
    {
        public static List<PageVisit> GetPageVisits()
        {
            ...
            { 
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand(@"SELECT login_history_page.page_description, COUNT(*) AS PageCount 
