...
namespace erp.Model.DAL
{
    public class Returns_commentsDAL
	{
		...
		public static List<Returns_comments> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM returns_comments", conn);
        ...
        public static List<Returns_comments> GetByReturn(int return_id)
        {
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM returns_comments INNER JOIN userusers ON returns_comments.comments_from = userusers.useruserid WHERE return_id = @return_id", conn);
		...
		public static Returns_comments GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM returns_comments WHERE comments_id = @id", conn);
		...
		public static void Delete(int comments_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM returns_comments WHERE comments_id = @id" , conn);
