...
namespace erp.Model.DAL
{
    public class CurrenciesDAL
	{
		...
		public static List<Currencies> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM currencies", conn);
		...
		public static Currencies GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM currencies WHERE curr_code = @id", conn);
		...
		public static void Delete(int curr_code)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = Utils.GetCommand("DELETE FROM currencies WHERE curr_code = @id" , conn);
