...
namespace erp.Model.DAL
{
    public class Container_typesDAL
	{
		...
		public static List<Container_types> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM container_types", conn);
		...
		public static Container_types GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = Utils.GetCommand("SELECT * FROM container_types WHERE container_type_id = @id", conn);
		...
		public static void Delete(int container_type_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = Utils.GetCommand("DELETE FROM container_types WHERE container_type_id = @id" , conn);
