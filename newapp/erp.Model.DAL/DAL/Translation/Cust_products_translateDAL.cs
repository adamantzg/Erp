...
namespace erp.Model.DAL
{
    public class Cust_products_translateDAL
	{
		...
		public static List<Cust_products_translate> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM cust_products_translate", conn);
		...
		public static Cust_products_translate GetById(int id, string lang)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM cust_products_translate WHERE cprod_id = @id AND lang = @lang", conn);
		...
		public static void Delete(int id, string lang)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM cust_products_translate WHERE cprod_id = @id AND lang = @lang" , conn);
                cmd.Parameters.AddWithValue("@id", id);
                cmd.Parameters.AddWithValue("@lang", lang);
                cmd.ExecuteNonQuery();
            }
