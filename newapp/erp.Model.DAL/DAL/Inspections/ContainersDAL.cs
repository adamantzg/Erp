...
namespace erp.Model.DAL
{
    public class ContainersDAL
	{
		...
		public static List<Containers> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM containers", conn);
        ...
        public static List<Containers> GetForInspection(int insp_id)
        {
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM containers WHERE insp_id = @insp_id", conn);
		...
		public static Containers GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM containers WHERE container_id = @id", conn);
		...
		public static Containers GetFromDataReader(MySqlDataReader dr)
		{
		...
		public static void Delete(int container_id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM containers WHERE container_id = @id" , conn);
