...
namespace erp.Model.DAL
{
    public class Stock_order_brand_allocationDAL
	{
		...
		public static List<Stock_order_brand_allocation> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM stock_order_brand_allocation", conn);
		...
		public static Stock_order_brand_allocation GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM stock_order_brand_allocation WHERE id = @id", conn);
		...
		public static void Delete(int id)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM stock_order_brand_allocation WHERE id = @id" , conn);
                cmd.Parameters.AddWithValue("@id", id);
                cmd.ExecuteNonQuery();
            }
		}
