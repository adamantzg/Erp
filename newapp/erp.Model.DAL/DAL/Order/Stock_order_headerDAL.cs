...
namespace erp.Model.DAL
{
    public class Stock_order_headerDAL
	{
		...
		public static List<Stock_order_header> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT stock_order_header.*, factory.* FROM stock_order_header LEFT OUTER JOIN users factory ON stock_order_header.userid = factory.User_id", conn);
        ...
        public static List<Stock_order_header> GetByCriteria(DateTime? from, DateTime? to, int? factory_id)
        {
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand(@"SELECT stock_order_header.*, factory.* FROM stock_order_header 
        ...
        public static Stock_order_header GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM stock_order_header WHERE porderid = @id", conn);
		...
		public static void Delete(int porderid)
		{
            ...
            {
                conn.Open();
				var cmd = Utils.GetCommand("DELETE FROM stock_order_header WHERE porderid = @id" , conn);
