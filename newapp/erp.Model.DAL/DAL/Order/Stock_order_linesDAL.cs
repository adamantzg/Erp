...
namespace erp.Model.DAL
{
    public class Stock_order_linesDAL
	{
		...
		public static List<Stock_order_lines> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM stock_order_lines", conn);
		...
		public static Stock_order_lines GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand("SELECT * FROM stock_order_lines WHERE linenum = @id", conn);
        ...
        public static void Delete(int linenum, MySqlTransaction tr = null)
		{
            ...
            if(tr == null)
                conn.Open();
			var cmd = Utils.GetCommand("DELETE FROM stock_order_lines WHERE linenum = @id" , conn);
        ...
        public static List<Stock_order_lines> GetForOrder(int id)
        {
            ...
            {
                conn.Open();
                var cmd = Utils.GetCommand(@"SELECT stock_order_lines.*, cust_products.*,mast_products.* FROM stock_order_lines 
