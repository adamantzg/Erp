...
namespace asaq2.Model
{
    public class Issue_statusDAL
	{
		...
		public static List<Issue_status> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM issue_status", conn);
		...
		public static Issue_status GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM issue_status WHERE status_id = @id", conn);
        ...
        public static void Create(Issue_status o)
        {
            ...
            using (var conn = new MySqlConnection(Properties.Settings.Default.ConnString))
            {
                ...
                MySqlCommand cmd = new MySqlCommand("SELECT MAX(status_id)+1 FROM issue_status", conn);
		...
		public static void Delete(int status_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = new MySqlCommand("DELETE FROM issue_status WHERE status_id = @id" , conn);
