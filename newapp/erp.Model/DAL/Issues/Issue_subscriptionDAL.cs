...
namespace asaq2.Model
{
    public class Issue_subscriptionDAL
	{
		...
		public static List<Issue_subscription> GetForIssue(int issue_id, bool loadDependents = true)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM issue_subscription WHERE issue_id = @issue_id", conn);
		...
		public static Issue_subscription GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM issue_subscription WHERE subs_id = @id", conn);
		...
		public static void Delete(int subs_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = new MySqlCommand("DELETE FROM issue_subscription WHERE subs_id = @id" , conn);
