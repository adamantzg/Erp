...
namespace asaq2.Model
{
    public class Sales_data_contractsDAL
	{
		...
		public static List<Sales_data_contracts> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM sales_data_contracts", conn);
		...
		public static Sales_data_contracts GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM sales_data_contracts WHERE sales_unique = @id", conn);
        ...
        public static Sales_data_contracts GetByProdAndMonth(int cprod_id, int month)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM Sales_data_contracts WHERE cprod_id = @cprod_id AND month21 = @month", conn);
		...
		public static void Delete(int sales_unique)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM sales_data_contracts WHERE sales_unique = @id" , conn);
