...
namespace asaq2.Model
{
    public class Mast_products_pricingDAL
	{
		...
		public static List<Mast_products_pricing> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM mast_products_pricing", conn);
        ...
        public static List<Mast_products_pricing> GetByFactory(int? factory_id = null)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand(@"SELECT mast_products_pricing.*,mast_products.*,client.* ,cust_products.*
		...
		public static Mast_products_pricing GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM mast_products_pricing WHERE id = @id", conn);
		...
		public static void Delete(int id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM mast_products_pricing WHERE id = @id" , conn);
                cmd.Parameters.AddWithValue("@id", id);
                cmd.ExecuteNonQuery();
            }
		}
