...
namespace asaq2.Model
{
    public class Npd_commentsDAL
	{
		...
		public static List<Npd_comments> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM npd_comments", conn);
        ...
        public static List<Npd_comments> GetForNpd(int npd_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand(@"SELECT npd_comments.*,userusers.*,npd_comments_files.* 
		...
		public static Npd_comments GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM npd_comments WHERE comments_id = @id", conn);
		...
		public static void Create(Npd_comments o, DbTransaction tr = null)
        {
            ...
            if(tr == null)
                conn.Open();
            MySqlCommand cmd = new MySqlCommand(insertsql, conn,(MySqlTransaction) tr);
		...
		public static void Delete(int comments_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM npd_comments WHERE comments_id = @id" , conn);
