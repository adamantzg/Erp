...
namespace asaq2.Model
{
    public class Npd_comments_filesDAL
	{
		...
		public static List<Npd_comments_files> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM npd_comments_files", conn);
		...
		public static Npd_comments_files GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM npd_comments_files WHERE file_id = @id", conn);
		...
		public static void Delete(int file_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM npd_comments_files WHERE file_id = @id" , conn);
