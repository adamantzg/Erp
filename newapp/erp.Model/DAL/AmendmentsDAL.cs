...
namespace asaq2.Model
{
    public class AmendmentsDAL
	{
		...
		public static List<Amendments> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM amendments", conn);
		...
		public static Amendments GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM amendments WHERE processid = @id", conn);
		...
		public static void Delete(int processid)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = new MySqlCommand("DELETE FROM amendments WHERE processid = @id" , conn);
