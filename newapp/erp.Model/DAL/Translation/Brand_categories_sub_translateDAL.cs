...
namespace asaq2.Model
{
    public class Brand_categories_sub_translateDAL
	{
		...
		public static List<Brand_categories_sub_translate> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM brand_categories_sub_translate", conn);
		...
		public static Brand_categories_sub_translate GetById(int id, string lang)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM brand_categories_sub_translate WHERE brand_sub_id = @id AND lang = @lang", conn);
		...
		public static void Delete(int id, string lang)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM brand_categories_sub_translate WHERE brand_sub_id = @id AND lang = @lang" , conn);
