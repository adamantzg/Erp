...
namespace asaq2.Model
{
    public class Web_products_translateDAL
	{
		...
		public static List<Web_products_translate> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM web_products_translate", conn);
		...
		public static Web_products_translate GetById(int id, string lang)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM web_products_translate WHERE web_unique = @id AND lang = @lang", conn);
		...
		public static void Delete(int id, string lang)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM web_products_translate WHERE web_unique = @web_unique AND lang = @lang" , conn);
