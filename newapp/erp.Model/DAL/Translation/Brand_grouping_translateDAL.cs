...
namespace asaq2.Model
{
    public class Brand_grouping_translateDAL
	{
		...
		public static List<Brand_grouping_translate> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM brand_grouping_translate", conn);
		...
		public static Brand_grouping_translate GetById(int id, string lang)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM brand_grouping_translate WHERE brand_group = @id AND lang = @lang", conn);
		...
		public static void Delete(int lang)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM brand_grouping_translate WHERE lang = @id" , conn);
