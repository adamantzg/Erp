...
namespace asaq2.Model
{
    public class After_sales_enquiry_comment_filesDAL
	{
		...
		public static List<After_sales_enquiry_comment_files> GetForComment(int comment_id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM after_sales_enquiry_comment_files WHERE comment_id = @comment_id ", conn);
		...
		public static After_sales_enquiry_comment_files GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM after_sales_enquiry_comment_files WHERE file_id = @id", conn);
		...
		public static void Delete(int file_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = new MySqlCommand("DELETE FROM after_sales_enquiry_comment_files WHERE file_id = @id" , conn);
