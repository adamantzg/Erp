...
namespace asaq2.Model
{
    public class After_sales_enquiry_sitevisitDAL
	{
		...
		public static List<After_sales_enquiry_sitevisit> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM after_sales_enquiry_sitevisit", conn);
        ...
        public static List<After_sales_enquiry_sitevisit> GetByEnquiry(int enquiry_id)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE after_sales_enquiry_sitevisit.enquiry_id = @enquiry_id", conn);
        ...
        public static After_sales_enquiry_sitevisit GetByReference(string referenceNumber, int? contractor_id = null)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE (after_sales_enquiry_sitevisit.contractor_id = @contractor_id OR @contractor_id IS NULL) AND after_sales_enquiry_sitevisit.reference_number = @refnumber", conn);
        ...
        public static List<After_sales_enquiry_sitevisit> GetByContractor(int contractor_id)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE after_sales_enquiry_sitevisit.contractor_id = @contractor_id", conn);
		...
		public static After_sales_enquiry_sitevisit GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE after_sales_enquiry_sitevisit.sitevisit_id = @id", conn);
        ...
        public static After_sales_enquiry_sitevisit GetLastVisit(int enquiry_id)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE after_sales_enquiry_sitevisit.enquiry_id = @enquiry_id ORDER BY datecreated DESC LIMIT 1", conn);
                cmd.Parameters.AddWithValue("@enquiry_id", enquiry_id);
                MySqlDataReader dr = cmd.ExecuteReader();
                if (dr.Read())
                {
		...
		public static void Delete(int sitevisit_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = new MySqlCommand("DELETE FROM after_sales_enquiry_sitevisit WHERE sitevisit_id = @id" , conn);
        ...
        public static List<After_sales_enquiry_sitevisit> GetByCreator(int creator_id)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE after_sales_enquiry_sitevisit.created_userid = @created_userid", conn);
        ...
        public static List<After_sales_enquiry_sitevisit> GetByDistributor(int user_id)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand(GetSelectSql() + " WHERE after_sales_enquiry.created_userid = @created_userid", conn);
