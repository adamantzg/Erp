...
namespace asaq2.Model
{
    public class Feedback_subscriptionsDAL
	{
		...
		public static List<Feedback_subscriptions> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM feedback_subscriptions", conn);
        ...
        public static List<Feedback_subscriptions> GetForReturn(int return_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand(@"SELECT * FROM feedback_subscriptions INNER JOIN userusers ON feedback_subscriptions.subs_useruserid = userusers.useruserid 
		...
		public static Feedback_subscriptions GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM feedback_subscriptions WHERE subs_id = @id", conn);
		...
		public static void Delete(int subs_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM feedback_subscriptions WHERE subs_id = @id" , conn);
