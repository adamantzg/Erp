...
namespace asaq2.Model
{
    public class Returns_comments_filesDAL
	{
		...
		public static List<Returns_comments_files> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM returns_comments_files", conn);
        ...
        public static List<Returns_comments_files> GetForComment(int comment_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM returns_comments_files WHERE return_comment_id = @comment_id", conn);
		...
		public static Returns_comments_files GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM returns_comments_files WHERE return_comment_file_id = @id", conn);
		...
		public static void Delete(int return_comment_file_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM returns_comments_files WHERE return_comment_file_id = @id" , conn);
