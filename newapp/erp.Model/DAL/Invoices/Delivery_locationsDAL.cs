...
namespace asaq2.Model
{
    public class Delivery_locationsDAL
	{
		...
		public static List<Delivery_locations> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM delivery_locations", conn);
        ...
        public static List<Delivery_locations> GetForClient(int client_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM delivery_locations WHERE cus_id = @client_id", conn);
		...
		public static Delivery_locations GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM delivery_locations WHERE unique_id = @id", conn);
		...
		public static void Delete(int unique_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM delivery_locations WHERE unique_id = @id" , conn);
