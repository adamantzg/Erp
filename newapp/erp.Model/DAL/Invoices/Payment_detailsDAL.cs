...
namespace asaq2.Model
{
    public class Payment_detailsDAL
	{
		...
		public static List<Payment_details> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM payment_details", conn);
        ...
        public static List<Payment_details> GetForCompany(int company_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM payment_details WHERE company_id = @company_id", conn);
		...
		public static Payment_details GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM payment_details WHERE payment_details_id = @id", conn);
		...
		public static void Delete(int payment_details_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM payment_details WHERE payment_details_id = @id" , conn);
