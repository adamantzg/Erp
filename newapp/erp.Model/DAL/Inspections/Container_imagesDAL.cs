...
namespace asaq2.Model
{
    public class Container_imagesDAL
	{
		...
		public static List<Container_images> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM container_images", conn);
        ...
        public static List<Container_images> GetForInspection(int insp_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM container_images WHERE insp_unique = @insp_id", conn);
		...
		public static Container_images GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM container_images WHERE image_unique = @id", conn);
		...
		public static void Delete(int image_unique)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM container_images WHERE image_unique = @id" , conn);
