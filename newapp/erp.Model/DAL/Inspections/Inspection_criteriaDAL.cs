...
namespace asaq2.Model
{
    public class Inspection_criteriaDAL
	{
		...
		public static List<Inspection_criteria> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_criteria", conn);
        ...
        public static List<Inspection_criteria> GetForCategory1(int category1_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_criteria WHERE category1_id = @category1", conn);
		...
		public static Inspection_criteria GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_criteria WHERE insp_criteria_id = @id", conn);
		...
		public static void Delete(int insp_criteria_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM inspection_criteria WHERE insp_criteria_id = @id" , conn);
