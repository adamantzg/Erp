...
namespace asaq2.Model
{
    public class Inspection_lines_rejectedDAL
	{
		...
		public static List<Inspection_lines_rejected> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_lines_rejected", conn);
        ...
        public static List<Inspection_lines_rejected> GetByInspection(int insp_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM Inspection_lines_rejected WHERE insp_unique = @insp_id", conn);
		...
		public static Inspection_lines_rejected GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_lines_rejected WHERE insp_line_unique = @id", conn);
		...
		public static void Delete(int insp_line_unique)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM inspection_lines_rejected WHERE insp_line_unique = @id" , conn);
