...
namespace asaq2.Model
{
    public class Inspection_imagesDAL
	{
		...
		public static List<Inspection_images> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_images", conn);
        ...
        public static List<Inspection_images> GetByInspection(int insp_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_images WHERE insp_unique = @insp_id", conn);
		...
		public static Inspection_images GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM inspection_images WHERE image_unique = @id", conn);
		...
		public static void Delete(int image_unique)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM inspection_images WHERE image_unique = @id" , conn);
