...
namespace asaq2.Model
{
    public class Analytics_categoriesDAL
	{
		...
		public static List<Analytics_categories> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM analytics_categories", conn);
		...
		public static Analytics_categories GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM analytics_categories WHERE category_id = @id", conn);
		...
		public static void Delete(int category_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM analytics_categories WHERE category_id = @id" , conn);
