...
namespace asaq2.Model
{
    public class Ie_countiesDAL
	{
		...
		public static List<Ie_counties> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM ie_counties", conn);
		...
		public static Ie_counties GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM ie_counties WHERE ie_id = @id", conn);
		...
		public static void Delete(int ie_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM ie_counties WHERE ie_id = @id" , conn);
