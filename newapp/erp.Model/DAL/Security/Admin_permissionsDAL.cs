...
namespace asaq2.Model
{
    public class Admin_permissionsDAL
	{
		...
		public static List<Admin_permissions> GetAll()
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM admin_permissions", conn);
        ...
        public static List<Admin_permissions> GetForCompany(int company_id)
        {
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM admin_permissions INNER JOIN userusers ON admin_permissions.userid = userusers.useruserid WHERE cusid = @company_id", conn);
		...
		public static Admin_permissions GetById(int id)
		{
            ...
            {
                conn.Open();
                var cmd = new MySqlCommand("SELECT * FROM admin_permissions WHERE permission_id = @id", conn);
		...
		public static void Delete(int permission_id)
		{
            ...
            {
                conn.Open();
				var cmd = new MySqlCommand("DELETE FROM admin_permissions WHERE permission_id = @id" , conn);
