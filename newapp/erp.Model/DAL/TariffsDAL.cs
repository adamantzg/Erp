...
namespace asaq2.Model
{
    public class TariffsDAL
	{
		...
		public static List<Tariffs> GetAll()
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM tariffs", conn);
		...
		public static Tariffs GetById(int id)
		{
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM tariffs WHERE tariff_id = @id", conn);
		...
		public static void Delete(int tariff_id)
		{
            ...
            {
                conn.Open();
				MySqlCommand cmd = new MySqlCommand("DELETE FROM tariffs WHERE tariff_id = @id" , conn);
