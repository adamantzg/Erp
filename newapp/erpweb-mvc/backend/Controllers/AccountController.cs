...
namespace backend.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(ILoginHistoryDetailDAL loginHistoryDetailDAL, ICompanyDAL companyDAL,
            IAdminPagesDAL adminPagesDAL, IAdminPagesNewDAL adminPagesNewDAL, IClientPagesAllocatedDAL clientPagesAllocatedDAL,
            IUserDAL userDAL, ILoginhistoryDAL loginhistoryDAL, IAccountService accountService, IUnitOfWork unitOfWork ) : 
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (!string.IsNullOrEmpty(returnUrl) && returnUrl.ToLower().Contains("/aftersalessitevisits"))
                return View("/Views/ExternalUser/Login.cshtml");
            else if (!string.IsNullOrEmpty(returnUrl) && returnUrl.ToLower().Contains("/ussales"))
                return View("/Views/UsSales/Login.cshtml");
            else if (!string.IsNullOrEmpty(returnUrl) && returnUrl.ToLower().Contains("/salesrep"))
                return View("/Views/SalesRep/Login.cshtml");
            else
                return View();
        }
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            User user;
            if(ModelState.IsValid && (user = userDAL.GetUser(model.UserName,model.Password)) != null)
            {
                string message;
                user = accountService.CheckIpAndTimeRestrictions(user, System.Web.HttpContext.Current, out message);
                if (user != null)
                {
                    LoginUser(user);
            ...
            if (!string.IsNullOrEmpty(returnUrl) && returnUrl.ToLower().Contains("/salesrep"))
                return View("/Views/SalesRep/Login.cshtml");
            return View(model);
        }
        ...
        public ActionResult LogOff()
        {
            ...
            Session[WebUtilities.CurrentUserSessionVar] = null;
