...
angular.module('plupload.directive', [])
	.provider('plUploadService', function() {
		...
		var config = {
			flashPath: '~/Scripts/plupload-angular-directive/lib/plupload/plupload.flash.swf',
			silverLightPath: '~/Scripts/plupload-angular-directive/lib/plupload/plupload.silverlight.xap',
