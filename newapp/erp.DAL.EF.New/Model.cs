...
namespace erp.DAL.EF.New
{
    ...
    public partial class Model : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Us_dealers>().Property(d => d.isInternal).HasColumnName("internal");
			...
			modelBuilder.Entity<Web_product_flow>().HasOptional(p => p.Pressure).WithMany().HasForeignKey(p => p.pressure_id);
			...
			modelBuilder.Entity<auto_add_products>().HasOptional(a=>a.AddedProduct).WithMany().HasForeignKey(a=>a.added_cprod_id);

			modelBuilder.Entity<Inspection_v2_image_type>().ToTable("Inspection_v2_image_type");

			modelBuilder.Entity<Material>().ToTable("material");
			modelBuilder.Entity<Packaging>().ToTable("packaging");

			modelBuilder.Entity<Mast_products_packaging_material>().HasOptional(m => m.Material).WithMany().HasForeignKey(m => m.material_id);
			modelBuilder.Entity<Mast_products_packaging_material>().HasOptional(m => m.Packaging).WithMany().HasForeignKey(m => m.packaging_id);

			modelBuilder.Entity<File>().ToTable("file");
			
			modelBuilder.Entity<ports>().ToTable("ports").HasKey(p=>p.port_id);
			modelBuilder.Entity<sales_forecast_contract>().ToTable("sales_forecast_contracts");

			modelBuilder.Entity<forward_order_lines>().ToTable("forward_order_lines");
			modelBuilder.Entity<web_product_info_type>().ToTable("web_product_info_type");

			modelBuilder.Entity<tickets>().ToTable("2011_tickets");
			...
			modelBuilder.Configurations.Add(new ProductFilesMappings());
			modelBuilder.Configurations.Add(new ProductFileTypesMappings());
			...
			modelBuilder.Entity<returns_events>().ToTable("returns_events");
